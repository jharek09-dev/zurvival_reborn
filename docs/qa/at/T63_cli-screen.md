...
> 🔊 
> 
> 🔊 Mode: Survivor — The intended balance — always a little short; every trip out costs more than it pays.
...
> 🔊 return
> 🔊 
> — Inventory — your pack — weight, categories, artifacts
...
> [Enter returns to the story · a choice number, screen key, S or Q works from here too]
> > 

- PASS said `— Inventory — your pack`
- PASS said `Pack: 12/40 weight`
- PASS said `Enter returns to the story`
- PASS never said `What do you do?`
