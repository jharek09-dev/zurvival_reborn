...
export {
  ...
  discoveredNodeIds,
  discoverAround,
  // Scouting — looking before you walk (T84 · FR-MAP-02)
  isScouted,
  scoutIsFresh,
  markScoutedHere,
  nodesWithin,
...
export {
  ...
  // Aftermath: what a kill leaves on a node, and how it fades (T84)
...
export {
  ...
  searchYieldCap,
  resolveSearchLoot,
  // Per-node loot depth + loot-as-yield (T84 · FR-ECO-02 · GDD X)
  resolveSearch,
  type SearchHaul,
  ITEM_LOOT_WEIGHT,
  itemLootWeight,
...
// --- the terminal project (M5 task T87) ---------------------------------------------------------
export {
  projectsActive,
  projectPool,
  committedProject,
