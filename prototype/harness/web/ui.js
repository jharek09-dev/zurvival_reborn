...
(function () {
  ...
  function newRun(seed, difficulty, ironman) {
    var r = Z.startRun(metaFor(seed, difficulty, ironman),
      ...
      C.encounters, C.signals, C.recipes, C.jobs, C.factions, C.weapons, C.projects, C.endings);
  ...
  function rebuildGraph() {
    return Z.buildRegionGraph(C.regions, C.nodes, C.encounters, C.signals, C.recipes, C.jobs, C.factions, C.npcs, C.weapons, C.projects, C.endings);
  }
